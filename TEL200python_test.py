...
x_pos = 0  # startposisjon
speed = 0.0005  # hvor fort den går fremover
...
for i in range(4000):
    ...
    # flytt kropp og bein fremover
    x_pos += speed
    body.base = SE3(x_pos, 0, 0)
    legs[0].base = SE3(x_pos + L/2,  -W/2, 0)
    legs[1].base = SE3(x_pos - L/2,  -W/2, 0)
    legs[2].base = SE3(x_pos + L/2,   W/2, 0) * leg_adjustment
    legs[3].base = SE3(x_pos - L/2,   W/2, 0) * leg_adjustment
